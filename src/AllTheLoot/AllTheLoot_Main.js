...
exports.allTheLoot = void 0;
const AllTheLoot_Helper_1 = require("../AllTheLoot/AllTheLoot_Helper");
const AllTheLoot_FillContainers_1 = require("./AllTheLoot_FillContainers");
const config_json_1 = __importDefault(require("../../Config/config.json"));
const config_Blacklisting_ID_json_1 = __importDefault(require("../../Config/config_Blacklisting_ID.json"));
const config_Containers_ID_json_1 = __importDefault(require("../../Config/config_Containers_ID.json"));
const config_FavoriteItems_ID_json_1 = __importDefault(require("../../Config/config_FavoriteItems_ID.json"));
const config_QuestItems_ID_json_1 = __importDefault(require("../../Config/config_QuestItems_ID.json"));
const config_CategorySpawnrates_json_1 = __importDefault(require("../../Config/config_CategorySpawnrates.json"));
const config_SelectedItems_ID_json_1 = __importDefault(require("../../Config/config_SelectedItems_ID.json"));
const ConfigTypes_1 = require("C:/snapshot/project/obj/models/enums/ConfigTypes");
class allTheLoot {
    static tables;
    static Logger;
    static config = config_json_1.default;
    static config_Blacklisting = config_Blacklisting_ID_json_1.default;
    static config_Containers = config_Containers_ID_json_1.default;
    static config_FavoriteItems = config_FavoriteItems_ID_json_1.default;
    static config_QuestItems = config_QuestItems_ID_json_1.default;
    static config_CategorySpawnrates = config_CategorySpawnrates_json_1.default;
    static config_SelectedItems = config_SelectedItems_ID_json_1.default;
    static staticAmmo = {};
    // caliber | ammo ID, spawn rate
    static initialItems = [];
    static lootItems = [];
    static amountOfQuestItems = 0;
    static amountOfBlacklistedItems = 0;
    static pluginInitialized = false;
    static configServer;
    static containerIndexDebug = config_json_1.default.debugMode_containerIndex;
    static containerTypeDrawer = [];
    static containerTypeCashRegister = [];
    static containerTypePCBlock = [];
    static containerTypeJacket = [];
    static containerTypeToolbox = [];
    static containerTypeMedcase = [];
    static containerTypeSafe = [];
    static containerTypeWeaponbox5x5 = [];
    static containerTypeWeaponbox5x2 = [];
    static containerTypeSportsbag01 = [];
    static containerTypeWeaponbox6x3 = [];
    static containerTypeWeaponbox4x4 = [];
    static containerTypeGrenadebox = [];
    static containerTypePlasticSuitcase = [];
    static containerTypeMedbagSMU0601 = [];
    static containerTypeWoodenCrate = [];
    static containerTypeMedicalSupplyCrate = [];
    static containerTypeTechnicalSupplyCrate = [];
    static containerTypeDeadScav = [];
    static containerTypeGroundCache = [];
    static containerTypeBurriedBarrelCache = [];
    static containerTypeWoodenAmmobox = [];
    static containerTypeJacketDorms114 = [];
    static containerTypeJacketMachineryKey = [];
    static containerTypeRationSupplyCrate = [];
    static containerTypeJacketDorms204 = [];
    static containerTypeCommonFundStash = [];
    static containerTypeSportsbag02 = [];
    static containerTypeMedbagSMU0602 = [];
    static containerTypeCashRegisterTAR = [];
    static containerTypeBankCashRegister = [];
    static containerTypeBankSafe = [];
    // 3.8.0
    static containerTypePMCBody = [];
    static containerTypDeadCivilian = [];
    static containerTypeScavBody = [];
    static containerTypeLabTechnicianBody = [];
    static allItemsAssignedToContainers = [
    ...
    static readHandbook() {
        ...
        for (let i = 0; i < handbookItems.length; i++) {
            const currentParent = (0, AllTheLoot_Helper_1.mapParentIdToCategoryName)(handbookItems[i].ParentId);
            ...
            if (config_json_1.default.favoriteItems)
                isFavoriteItem = this.config_FavoriteItems.favoriteItems.includes(handbookItems[i].Id);
            if (config_json_1.default.questItems)
                isQuestItem = this.config_QuestItems.questItems.includes(handbookItems[i].Id);
            const isCustomAdded = false;
            if (currentParent === AllTheLoot_Helper_1.SPTLootCategoryName.QUEST)
                continue;
            // apply global blacklist
            if (config_Blacklisting_ID_json_1.default.blacklistedItems_Global.includes(handbookItems[i].Id)) {
                this.amountOfBlacklistedItems++;
                continue;
            }
            // if equal spawn rate for all items is active, check if pouches should be included or excluded
            if (currentParent === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_SECURECONTAINERS && config_json_1.default.equalSpawnratesForAllItems && config_json_1.default.equalSpawnratesForAllItemsExcludePouches)
                continue;
            const newItem = {
        ...
        if (config_json_1.default.showItemListing) {
    ...
    static updateSpawnRates() {
        ...
        (0, AllTheLoot_FillContainers_1.fillContainersWithLoot)(tables, this.allItemsAssignedToContainers);
        ...
        this.lootItems.forEach(element => {
            if (element.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_BACKPACKS)
        ...
        if (!this.config.allowDuplicates) {
            const lootConfig = this.configServer.getConfig(ConfigTypes_1.ConfigTypes.LOCATION);
            lootConfig.allowDuplicateItemsInStaticContainers = false;
        }
        if (config_json_1.default.debugMode_showContainerInfo && !this.pluginInitialized) {
            this.Logger.warning("Items in container ||" + (0, AllTheLoot_Helper_1.getContainerName)(this.containerIndexDebug) + "||: " + this.allItemsAssignedToContainers[this.containerIndexDebug].length);
        ...
        if (config_json_1.default.shuffleArrays) {
    ...
    static applyContainerBlacklisting() {
        if (config_json_1.default.debugMode_showContainerInfo && !this.pluginInitialized)
            this.Logger.info("Available items for container ||" + (0, AllTheLoot_Helper_1.getContainerName)(this.containerIndexDebug) + "||: " + this.allItemsAssignedToContainers[this.containerIndexDebug].length.toString());
        for (let i = 0; i < this.allItemsAssignedToContainers.length; i++) {
            this.allItemsAssignedToContainers[i] = this.allItemsAssignedToContainers[i].filter(item => !config_Blacklisting_ID_json_1.default["blacklistedItems_" + (0, AllTheLoot_Helper_1.mapContainerIndexToContainerName)(i)].includes(item.itemId));
        }
        if (config_json_1.default.debugMode_showContainerInfo && !this.pluginInitialized) {
            this.Logger.info("Remaining items after blacklisting in container ||" + (0, AllTheLoot_Helper_1.getContainerName)(this.containerIndexDebug) + "||: " + this.allItemsAssignedToContainers[this.containerIndexDebug].length.toString());
        }
    }
    static adjustValueBasedContainers() {
        if (config_Containers_ID_json_1.default.highTierContainerAssignmentBySlotValue) // Item assignment based on single slot value (weapons, body armor, tactical rigs and favorite Items based on config settings)
         {
            // adjust Weaponbox 5x5
            this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX5X5] = this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX5X5].filter(item => {
                return (((item.itemPrice / (item.itemHeight * item.itemWidth)) > config_Containers_ID_json_1.default.container_WeaponBox5x5_MinValuePerSlot &&
                    (item.itemPrice / (item.itemHeight * item.itemWidth)) < config_Containers_ID_json_1.default.container_WeaponBox5x5_MaxValuePerSlot) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_Weapons &&
                        ((item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTCARBINES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTRIFLES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_BOLTACTIONRIFLES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_GRENADELAUNCHERS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_MACHINEGUNS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_MARKSMANRIFLES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SMGS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SHOTGUNS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_PISTOLS) && (item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox5x5_MinValuePerSlot && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox5x5_MaxValuePerSlot))) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_BodyArmor &&
                        (item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_BODYARMOR && (item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox5x5_MinValuePerSlot && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox5x5_MaxValuePerSlot))) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_TacticalRigs &&
                        (item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_TACTICALRIGS && (item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox5x5_MinValuePerSlot && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox5x5_MaxValuePerSlot))) ||
                    (item.itemFavorite));
            });
            // adjust Weaponbox 6x3
            this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX6X3] = this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX6X3].filter(item => {
                return (((item.itemPrice / (item.itemHeight * item.itemWidth)) > config_Containers_ID_json_1.default.container_WeaponBox6x3_MinValuePerSlot &&
                    (item.itemPrice / (item.itemHeight * item.itemWidth)) < config_Containers_ID_json_1.default.container_WeaponBox6x3_MaxValuePerSlot) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_Weapons &&
                        ((item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTCARBINES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTRIFLES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_BOLTACTIONRIFLES ||
                            ...
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SMGS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SHOTGUNS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_PISTOLS) && (item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox6x3_MinValuePerSlot && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox6x3_MaxValuePerSlot))) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_BodyArmor &&
                        (item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_BODYARMOR && (item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox6x3_MinValuePerSlot && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox6x3_MaxValuePerSlot))) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_TacticalRigs &&
                        (item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_TACTICALRIGS && (item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox6x3_MinValuePerSlot && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox6x3_MaxValuePerSlot))) ||
                    (item.itemFavorite));
            });
            // adjust Common Fund Stash
            this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.COMMONFUNDSTASH] = this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.COMMONFUNDSTASH].filter(item => {
                return (((item.itemPrice / (item.itemHeight * item.itemWidth)) > config_Containers_ID_json_1.default.container_CommonFundStash_MinValuePerSlot &&
                    (item.itemPrice / (item.itemHeight * item.itemWidth)) < config_Containers_ID_json_1.default.container_CommonFundStash_MaxValuePerSlot) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_Weapons &&
                        ((item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTCARBINES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTRIFLES ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_BOLTACTIONRIFLES ||
                            ...
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SMGS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SHOTGUNS ||
                            item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_PISTOLS) && (item.itemPrice > config_Containers_ID_json_1.default.slotOption_alwaysInclude_Weapons_MinValue))) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_BodyArmor &&
                        (item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_BODYARMOR && (item.itemPrice > config_Containers_ID_json_1.default.slotOption_alwaysInclude_BodyArmor_MinValue))) ||
                    (config_Containers_ID_json_1.default.slotOption_alwaysInclude_TacticalRigs &&
                        (item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_TACTICALRIGS && (item.itemPrice > config_Containers_ID_json_1.default.slotOption_alwaysInclude_TacticalRigs_MinValue))));
            });
        }
        else // Item assignment solely based on item value
         {
            // adjust Weaponbox 5x5
            this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX5X5] = this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX5X5].filter(item => {
                return ((item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox5x5_MinValuePerItem && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox5x5_MaxValuePerItem) || item.itemFavorite);
            });
            // adjust Weaponbox 6x3
            this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX6X3] = this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX6X3].filter(item => {
                return ((item.itemPrice > config_Containers_ID_json_1.default.container_WeaponBox6x3_MinValuePerItem && item.itemPrice < config_Containers_ID_json_1.default.container_WeaponBox6x3_MaxValuePerItem) || item.itemFavorite);
            });
            // adjust Common Fund Stash
            this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.COMMONFUNDSTASH] = this.allItemsAssignedToContainers[AllTheLoot_Helper_1.SPTLootContainerIndex.COMMONFUNDSTASH].filter(item => {
                return ((item.itemPrice > config_Containers_ID_json_1.default.container_CommonFundStash_MinValuePerItem && item.itemPrice < config_Containers_ID_json_1.default.container_CommonFundStash_MaxValuePerItem) || item.itemFavorite);
            });
        }
    }
    static adjustInitialSpawnrates() {
        const initSpawnrate_Tier7 = config_json_1.default.initSpawnrate_Tier7;
        const initSpawnrate_Tier6 = config_json_1.default.initSpawnrate_Tier6;
        const initSpawnrate_Tier5 = config_json_1.default.initSpawnrate_Tier5;
        const initSpawnrate_Tier4 = config_json_1.default.initSpawnrate_Tier4;
        const initSpawnrate_Tier3 = config_json_1.default.initSpawnrate_Tier3;
        const initSpawnrate_Tier2 = config_json_1.default.initSpawnrate_Tier2;
        const initSpawnrate_Tier1 = config_json_1.default.initSpawnrate_Tier1;
        const randomize = config_json_1.default.randomizerActive;
        const rndPercentage_Tier7 = config_json_1.default.randomizerPercentage_Tier7;
        const rndPercentage_Tier6 = config_json_1.default.randomizerPercentage_Tier6;
        const rndPercentage_Tier5 = config_json_1.default.randomizerPercentage_Tier5;
        const rndPercentage_Tier4 = config_json_1.default.randomizerPercentage_Tier4;
        const rndPercentage_Tier3 = config_json_1.default.randomizerPercentage_Tier3;
        const rndPercentage_Tier2 = config_json_1.default.randomizerPercentage_Tier2;
        const rndPercentage_Tier1 = config_json_1.default.randomizerPercentage_Tier1;
        this.allItemsAssignedToContainers.forEach(container => {
            container.forEach(element => {
                if (element.itemPrice < 2000 && (AllTheLoot_Helper_1.selectedCategories.includes(element.itemLootCategory)))
                    element.itemSpawnrate = Math.floor((randomize ? ((1 - rndPercentage_Tier6) + rndPercentage_Tier6 * Math.random()) : 1) * initSpawnrate_Tier6);
                else if (element.itemPrice < 2000 && (!AllTheLoot_Helper_1.selectedCategories.includes(element.itemLootCategory)))
    ...
    static applyNormalizedWeighting() {
        ...
        this.allItemsAssignedToContainers.forEach((container, index) => {
            ...
            if (config_json_1.default.debugMode_showContainerInfo && index == this.containerIndexDebug && !this.pluginInitialized)
                this.Logger.info("Container " + (0, AllTheLoot_Helper_1.getContainerName)(index) + " has " + container.length + " item(s) from " + categoriesInContainer.length.toString() + " categories");
    ...
    static spawnRateFinalAdjustment() {
        this.allItemsAssignedToContainers.forEach((container, index) => {
            container.forEach(category => {
                category.itemSpawnrate = Math.floor(category.itemSpawnrate * config_CategorySpawnrates_json_1.default["rate_" + category.itemLootCategory]); // adjust spawn rate on category basis
                if (category.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.KEYS_MECHANICALKEYS && (index === AllTheLoot_Helper_1.SPTLootContainerIndex.JACKET || index === AllTheLoot_Helper_1.SPTLootContainerIndex.JACKETDORMS204)) // increase key spawn rates in jackets
                    category.itemSpawnrate = Math.floor(category.itemSpawnrate * config_json_1.default.keysInJacketsMultiplier);
                if (config_SelectedItems_ID_json_1.default.selectedItems_AdjustSpawnChance.includes(category.itemId)) // adjust spawn rate on item basis
                 {
                    const selectedItemIndex = config_SelectedItems_ID_json_1.default.selectedItems_AdjustSpawnChance.indexOf(category.itemId);
                    category.itemSpawnrate *= parseFloat(config_SelectedItems_ID_json_1.default.selectedItems_spawnChance[selectedItemIndex]);
                    category.itemSpawnrate = Math.floor(category.itemSpawnrate);
                }
            });
            if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.JACKETDORMS114) // adjust spawn rates of JacketDorms114 to an equal rate for all contained items
             {
                container.forEach(element => {
                    element.itemSpawnrate = 1;
                });
            }
            if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.COMMONFUNDSTASH) // adjust spawn rates of Common Fund Stash to an equal rate for all contained items
             {
                container.forEach(element => {
                    element.itemSpawnrate = 1;
                });
            ...
            const itemsKeys = container.filter(item => item.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.KEYS_MECHANICALKEYS);
            ...
            if (config_json_1.default.debugMode_showContainerInfo && index == this.containerIndexDebug && !this.pluginInitialized) {
                this.Logger.info("Spawn rates in container " + (0, AllTheLoot_Helper_1.getContainerName)(index));
            ...
            container.forEach(element => {
                ...
                if (config_SelectedItems_ID_json_1.default.selectedItems_AdjustSpawnChance.includes(element.itemId)) {
                    const selectedItemIndex = config_SelectedItems_ID_json_1.default.selectedItems_AdjustSpawnChance.indexOf(element.itemId);
                    selectedItemMultiplier = parseFloat(config_SelectedItems_ID_json_1.default.selectedItems_spawnChance[selectedItemIndex]);
                }
                if (element.itemQuest) {
                    if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX5X5 ||
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX5X2 ||
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX6X3 ||
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX4X4 ||
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.WOODENCRATE)
                        element.itemSpawnrate = Math.floor(averageSpawnrate * selectedItemMultiplier * config_json_1.default.questItemsMultiplierWeaponboxes);
                    else if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.JACKETDORMS114)
                        element.itemSpawnrate = 1;
                    else if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.COMMONFUNDSTASH)
                        element.itemSpawnrate = 1;
                    else
                        element.itemSpawnrate = Math.floor(averageSpawnrate * selectedItemMultiplier * config_json_1.default.questItemsMultiplierStandardContainer);
                }
                if (element.itemFavorite) {
                    if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX5X5 ||
                        ...
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.WEAPONBOX4X4 ||
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.WOODENCRATE ||
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.DEADSCAV ||
                        index === AllTheLoot_Helper_1.SPTLootContainerIndex.PMCBODY) {
                        if (element.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.AMMO_AMMOPACKS || element.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.AMMO_ROUNDS)
                            element.itemSpawnrate = Math.floor(averageSpawnrate * selectedItemMultiplier * config_json_1.default.favoriteItemsMultiplierWeaponboxes * config_json_1.default.favoriteItemsMultiplierWeaponboxesAmmoMulti);
                        else
                            element.itemSpawnrate = Math.floor(averageSpawnrate * selectedItemMultiplier * config_json_1.default.favoriteItemsMultiplierWeaponboxes);
                    }
                    else if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.JACKETDORMS114)
                        element.itemSpawnrate = 1;
                    else if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.COMMONFUNDSTASH)
                        ...
                        element.itemSpawnrate = Math.floor(averageSpawnrate * selectedItemMultiplier * config_json_1.default.favoriteItemsMultiplierStandardContainer);
                }
                // equal key spawn rates in drawers and jackets
                if (element.itemLootCategory === AllTheLoot_Helper_1.SPTLootCategoryName.KEYS_MECHANICALKEYS && this.config.equalSpawnratesForAllKeys) {
                    ...
                    if (index === AllTheLoot_Helper_1.SPTLootContainerIndex.JACKET || index === AllTheLoot_Helper_1.SPTLootContainerIndex.JACKETDORMS204)
                        element.itemSpawnrate *= config_json_1.default.keysInJacketsMultiplier;
                }
            });
        });
    }
    static assignItemsToContainerTypes(currentItem) {
        const currentItemCopy = { ...currentItem }; // create shallow copy to have independent spawn rates
        switch (currentItem.itemLootCategory) {
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_OTHERS:
                ...
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_BUILDINGMATERIALS:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                this.containerTypeJacket.push({ ...currentItemCopy });
                ...
                this.containerTypDeadCivilian.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_ELECTRONICS:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_ENERGYELEMENTS:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                this.containerTypeJacket.push({ ...currentItemCopy });
                this.containerTypeToolbox.push({ ...currentItemCopy });
                this.containerTypeSportsbag01.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_FLAMMABLEMATERIALS:
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_HOUSEHOLDMATERIALS:
                ...
                this.containerTypDeadCivilian.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_MEDICALSUPPLIES:
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_TOOLS:
                this.containerTypeJacket.push({ ...currentItemCopy });
                this.containerTypeToolbox.push({ ...currentItemCopy });
                this.containerTypeSportsbag01.push({ ...currentItemCopy });
                this.containerTypePlasticSuitcase.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.BARTER_VALUABLES:
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_BACKPACKS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_BODYARMOR:
                this.containerTypeGroundCache.push({ ...currentItemCopy });
                this.containerTypeBurriedBarrelCache.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_EYEWEAR:
                this.containerTypeGroundCache.push({ ...currentItemCopy });
                this.containerTypeBurriedBarrelCache.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_FACECOVERS:
                this.containerTypeJacket.push({ ...currentItemCopy });
                this.containerTypeSportsbag01.push({ ...currentItemCopy });
                this.containerTypeGroundCache.push({ ...currentItemCopy });
                this.containerTypeBurriedBarrelCache.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_GEARCOMPONENTS:
                this.containerTypeGroundCache.push({ ...currentItemCopy });
                this.containerTypeBurriedBarrelCache.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_HEADGEAR:
                this.containerTypeGroundCache.push({ ...currentItemCopy });
                this.containerTypeBurriedBarrelCache.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_HEADSETS:
                this.containerTypeGroundCache.push({ ...currentItemCopy });
                this.containerTypeBurriedBarrelCache.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_SECURECONTAINERS:
                this.containerTypeTechnicalSupplyCrate.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_STORAGECONTAINERS:
                this.containerTypeTechnicalSupplyCrate.push({ ...currentItemCopy });
                ...
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.GEAR_TACTICALRIGS:
                this.containerTypeGroundCache.push({ ...currentItemCopy });
                this.containerTypeBurriedBarrelCache.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_AUXILIARYPARTS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_BIPODS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_FOREGRIPS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_LLD_FLASHLIGHTS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_LLD_LASERTARGETPOINTERS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_LLD_TACTICALCOMBODEVICES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_MD_FLASHHIDERSBRAKES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_MD_MUZZLEADAPTERS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_MD_SUPPRESSORS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_S_ASSAULTSCOPES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_S_COLLIMATORS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_S_COMPACTCOLLIMATORS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_S_IRONSIGHTS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                this.containerTypeWoodenCrate.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_S_OPTICS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_FM_S_SPECIALPURPOSESIGHTS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_GM_CHARGINGHANDLES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_GM_LAUNCHERS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_GM_MAGAZINES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_GM_MOUNTS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_GM_STOCKSCHASSIS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_VP_BARRELS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_VP_GASBLOCKS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_VP_HANDGUARDS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_VP_PISTOLGRIPS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WPM_VP_RECEIVERSSLIDES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTCARBINES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_ASSAULTRIFLES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_BOLTACTIONRIFLES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_GRENADELAUNCHERS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_MACHINEGUNS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_MARKSMANRIFLES:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_MELEEWEAPONS:
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_PISTOLS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SMGS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SHOTGUNS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                this.containerTypeCommonFundStash.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_SPECIALWEAPONS:
                this.containerTypeWeaponbox5x5.push({ ...currentItemCopy });
                this.containerTypeWeaponbox5x2.push({ ...currentItemCopy });
                this.containerTypeWeaponbox6x3.push({ ...currentItemCopy });
                this.containerTypeWeaponbox4x4.push({ ...currentItemCopy });
                ...
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.WEAPONS_THROWABLES:
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.AMMO_AMMOPACKS:
                ...
                this.containerTypeWoodenCrate.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.AMMO_ROUNDS:
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.PROVISIONS_DRINKS:
                ...
                this.containerTypDeadCivilian.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.PROVISIONS_FOOD:
                ...
                this.containerTypDeadCivilian.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.MEDICATION_INJECTORS:
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.MEDICATION_INJURYTREATMENT:
                this.containerTypeMedcase.push({ ...currentItemCopy });
                this.containerTypeSportsbag01.push({ ...currentItemCopy });
                this.containerTypePlasticSuitcase.push({ ...currentItemCopy });
                this.containerTypeMedbagSMU0601.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.MEDICATION_MEDKITS:
                this.containerTypeMedcase.push({ ...currentItemCopy });
                this.containerTypeSportsbag01.push({ ...currentItemCopy });
                this.containerTypePlasticSuitcase.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.MEDICATION_PILLS:
                this.containerTypeMedcase.push({ ...currentItemCopy });
                this.containerTypeSportsbag01.push({ ...currentItemCopy });
                this.containerTypePlasticSuitcase.push({ ...currentItemCopy });
                this.containerTypeJacketDorms114.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.KEYS_ELECTRONICKEYS:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                if (config_json_1.default.keycardsInJackets) {
                    this.containerTypeJacket.push({ ...currentItemCopy });
                    this.containerTypeJacketDorms204.push({ ...currentItemCopy });
                }
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.KEYS_MECHANICALKEYS:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                this.containerTypeJacket.push({ ...currentItemCopy });
                this.containerTypeJacketDorms204.push({ ...currentItemCopy });
                ...
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.INFOITEMS:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.SPECIALEQUIPMENT:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                this.containerTypeJacket.push({ ...currentItemCopy });
                this.containerTypeSportsbag01.push({ ...currentItemCopy });
                this.containerTypePlasticSuitcase.push({ ...currentItemCopy });
                ...
                this.containerTypePMCBody.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.MAPS:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                break;
            case AllTheLoot_Helper_1.SPTLootCategoryName.MONEY:
                this.containerTypeDrawer.push({ ...currentItemCopy });
                this.containerTypeJacket.push({ ...currentItemCopy });
    ...
    static checkAmmoCaliber(currentItem) {
...
exports.allTheLoot = allTheLoot;
//# sourceMappingURL=AllTheLoot_Main.js.map